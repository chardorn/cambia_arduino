...
// See spec. para 4.3.2
#define GATEWAYNODE 1 //CHANGED THIS FROM 0 to 1
#define _CHECK_MIC 0

#if GATEWAYNODE==1
#define _DEVADDR { 0x26, 0x05, 0x1C, 0xCE }
#define _APPSKEY { 0x97, 0xCD, 0x09, 0x35, 0x05, 0x08, 0x60, 0x93, 0x26, 0x1F, 0xD1, 0x81, 0x71, 0xBF, 0xAA, 0x1E }
#define _NWKSKEY { 0xB8, 0xD8, 0x4A, 0xE0, 0x87, 0x2A, 0xD7, 0x6A, 0x17, 0x33, 0x1C, 0x84, 0x62, 0x19, 0x86, 0xEB }
...
wpas wpa[] = {
  ...
  { "Blue-butted Cricket", "breezyshrub" },
  { "Charlotte Dorn's iPhone", "breezyshrub" },
  { "pink pants cricket", "breezyshrub" }
};
